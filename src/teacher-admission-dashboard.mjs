...
function renderSummary() {
  ...
  $('#admission-dashboard-quality-summary').innerHTML = [
    ...
    summaryCard('인문', `${summary.quality.academicFieldInfo.counts.humanities.toLocaleString('ko-KR')}건`),
    summaryCard('자연', `${summary.quality.academicFieldInfo.counts.natural.toLocaleString('ko-KR')}건`),
    summaryCard('예체능', `${summary.quality.academicFieldInfo.counts.arts.toLocaleString('ko-KR')}건`),
