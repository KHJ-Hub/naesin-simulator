...
test('관심 대학은 인쇄에 필요한 비교 정보까지 보존한다', () => {
  ...
  assert.deepEqual(saved, { ...interest, admissionType: '', admissionCategory: '', category: '', eligibilityType: 'unknown', eligibilityVerification: '', regionalEligibility: null, studentDefaultVisible: false, comparisonBasis: 'current' });
});
